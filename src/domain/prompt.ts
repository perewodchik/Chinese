  ...
  out.push(
    list(
      [
        ...
        'Pinyin: tone marks, lower case, no punctuation, and one group per word — the syllables of a word written together, words apart: `wǒ de péngyou zài chī zǎofàn`, not `wǒ de péng you zài chī zǎo fàn` and not `ni3 hao3`. A name is one word (`guǎngzhōu`); 了, 的 and 吗 stand alone. My screen shows where the words are from this grouping, so it matters as much as the tones.',
...
export function buildBrief(plan: TextPlan, extra: PromptExtras = {}): string {
  const brief = {
    ...
    rules: [
      ...
      'Pinyin with tone marks, lower case, no punctuation, one group per word: the syllables of a word together, words apart ("wǒ de péngyou chī zǎofàn"). A name is one word; 了, 的 and 吗 stand alone. The learner\'s screen finds the words from this grouping.',
